                            ...
                            <flux:dropdown position="bottom" align="start">
                                ...
                                <flux:menu class="w-40">
                                    ...
                                    {{-- Master data is Archived (recoverable soft delete);
                                         ...
                                         the lead. See CLAUDE.md. --}}
                                    <flux:menu.separator />
                                    <button type="button" wire:click="archive" wire:confirm="Archive this lead? It will be hidden from the list but can be restored from the Archived filter." class="flex w-full items-center gap-2 px-2 py-1.5 text-sm text-zinc-600 hover:bg-zinc-50 dark:text-zinc-400 dark:hover:bg-zinc-800">
                                        <flux:icon name="archive-box" class="size-4" />
                                        <span>{{ __('common.archive') }}</span>
                                    </button>
                                    @if($this->canDelete)
                                        <button type="button" wire:click="delete" wire:confirm="Permanently delete this lead? This cannot be undone." class="flex w-full items-center gap-2 px-2 py-1.5 text-sm text-red-600 hover:bg-red-50 dark:text-red-400 dark:hover:bg-red-900/20">
                ...
                <div class="overflow-hidden rounded-lg border border-zinc-200 bg-white dark:border-zinc-800 dark:bg-zinc-900">
                    <div class="p-5">
                        ...
                        <div class="grid gap-6 sm:grid-cols-2">
                            ...
                            {{-- Settings Section --}}
                            <div class="sm:col-span-2 border-t border-zinc-100 pt-6 mt-2 dark:border-zinc-800">
                                <h4 class="mb-4 text-xs font-medium uppercase tracking-wider text-zinc-500 dark:text-zinc-400">Settings</h4>
                                <div class="grid gap-6 sm:grid-cols-3">
                                    <div>
                                        <label class="mb-2 block text-sm font-light text-zinc-600 dark:text-zinc-400">Source</label>
                                        <select wire:model="leadSource" class="w-full rounded-lg border border-zinc-200 bg-white px-3 py-2.5 text-sm text-zinc-900 focus:border-zinc-400 focus:outline-none dark:border-zinc-700 dark:bg-zinc-800 dark:text-zinc-100">
                                    ...
                                    <div>
                                        ...
                                        <select wire:model="leadStatus" class="w-full rounded-lg border border-zinc-200 bg-white px-3 py-2.5 text-sm text-zinc-900 focus:border-zinc-400 focus:outline-none dark:border-zinc-700 dark:bg-zinc-800 dark:text-zinc-100">
                                    ...
                                    <div>
                                        ...
                                        <select wire:model="assignedTo" class="w-full rounded-lg border border-zinc-200 bg-white px-3 py-2.5 text-sm text-zinc-900 focus:border-zinc-400 focus:outline-none dark:border-zinc-700 dark:bg-zinc-800 dark:text-zinc-100">
                                ...
                                <div class="border-t border-zinc-100 pt-6 dark:border-zinc-800">
                                    ...
                                    <div class="grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
                                        <div>
                                            ...
                                            <span class="mt-1 block text-sm text-zinc-900 dark:text-zinc-100">{{ $lead->created_at->format('M d, Y') }}</span>
                                        </div>
                                        @if($lead->updated_at && $lead->updated_at != $lead->created_at)
                                            <div>
                                                <span class="block text-xs text-zinc-500 dark:text-zinc-400">Updated</span>
                                                <span class="mt-1 block text-sm text-zinc-900 dark:text-zinc-100">{{ $lead->updated_at->format('M d, Y') }}</span>
                                            </div>
                                        @endif
                                        @if($lead->assignedTo)
                                            <div>
                                                <span class="block text-xs text-zinc-500 dark:text-zinc-400">Assigned To</span>
                                                <span class="mt-1 block text-sm text-zinc-900 dark:text-zinc-100">{{ $lead->assignedTo->name }}</span>
                                            </div>
                                        @endif
                                    </div>
                                </div>
