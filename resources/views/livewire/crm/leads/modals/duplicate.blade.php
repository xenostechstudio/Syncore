...
>
    <div class="mb-4 flex items-center gap-3">
        ...
        <div>
            <h3 class="text-lg font-semibold text-zinc-900 dark:text-zinc-100">Duplicate Lead</h3>
            <p class="text-sm text-zinc-500 dark:text-zinc-400">A new lead will be created from this one.</p>
        </div>
    </div>
    ...
    <div class="flex justify-end gap-3">
        ...
        >
            ...
            <span wire:loading.remove wire:target="duplicate">Duplicate Lead</span>
