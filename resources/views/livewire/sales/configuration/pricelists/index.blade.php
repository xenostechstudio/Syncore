<div>
    <x-ui.flash />    <x-ui.index-header
        title="Pricelists"
        :createRoute="route('sales.configuration.pricelists.create')"
    ...
    >
        ...
        <x-slot:search>
                            ...
                            @else
                                <x-ui.searchbox-dropdown placeholder="Search pricelists..." widthClass="w-[520px]" width="520px" :activeFilterCount="$this->getActiveFilterCount()" clearAction="clearFilters">
