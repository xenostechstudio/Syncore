    ...
    <div class="sticky top-14 z-40 -mx-4 -mt-6 mb-6 flex min-h-[60px] items-center border-b border-zinc-200 bg-white px-4 py-2 sm:-mx-6 lg:-mx-8 lg:px-6 dark:border-zinc-800 dark:bg-zinc-950">
        <div class="flex w-full items-center justify-between gap-4">
            ...
            <div class="flex flex-1 items-center justify-center">
                ...
                @else
                    <x-ui.searchbox-dropdown placeholder="Search pricelists..." widthClass="w-[520px]" width="520px">
        ...
        <table class="min-w-full divide-y divide-zinc-200 dark:divide-zinc-800">
            ...
            <tbody class="divide-y divide-zinc-200 dark:divide-zinc-800">
                @forelse ($pricelists as $pricelist)
                    @php $isSelected = in_array($pricelist->id, $selected); @endphp
                    <tr onclick="window.location.href='{{ route('sales.configuration.pricelists.edit', $pricelist->id) }}'" class="group cursor-pointer transition-all duration-150 {{ $isSelected ? 'bg-zinc-900/[0.03] dark:bg-zinc-100/[0.03]' : 'hover:bg-zinc-50 dark:hover:bg-zinc-800/50' }}">
                        <td class="relative py-4 pl-4 pr-1 sm:pl-6 lg:pl-8" onclick="event.stopPropagation()">
                            ...
                            <input type="checkbox" wire:model.live="selected" value="{{ $pricelist->id }}" class="rounded border-zinc-300 bg-white text-zinc-900 focus:ring-zinc-900 dark:border-zinc-700 dark:bg-zinc-800 dark:text-zinc-100 dark:focus:ring-zinc-600 {{ $isSelected ? 'ring-1 ring-zinc-900/20 dark:ring-zinc-100/20' : '' }}">
                        </td>
