<div>
    ...
    >
        ...
        <x-slot:search>
                            ...
                            <x-ui.searchbox-dropdown placeholder="Search products..." widthClass="w-[520px]" width="520px" align="center" :activeFilterCount="$this->getActiveFilterCount()" clearAction="clearFilters">
