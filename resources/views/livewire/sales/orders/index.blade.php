<div>
                            ...
                            <tr>
                                <th scope="col" class="relative w-10 py-3 pl-4 pr-2 sm:pl-6 lg:pl-8">
                                    ...
                                    <input 
                                        ...
                                        @if(count($selected) > 0 && count($selected) < $orders->count()) 
                    ...
                    <tbody class="divide-y divide-zinc-200 dark:divide-zinc-800">
                        @foreach ($orders as $order)
                            ...
                            >
                                ...
                                @if($visibleColumns['status'])
                                    <td class="px-4 py-3">
                                        <x-ui.status-badge :status="$order->state" class="px-2.5 py-0.5" />
                                    </td>
                                @endif
                                @if($visibleColumns['invoicing'])
    ...
    {{-- Import Modal (only shown when component has WithImport trait) --}}
    @if(property_exists($this, 'showImportModal'))
    <x-ui.import-modal
