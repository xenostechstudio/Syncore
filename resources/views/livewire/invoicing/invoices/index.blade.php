                        ...
                        @forelse($invoices as $invoice)
                            ...
                            >
                                <td class="relative py-4 pl-4 pr-1 sm:pl-6 lg:pl-8" onclick="event.stopPropagation()">
                                    ...
                                    <input type="checkbox" wire:model.live="selected" value="{{ $invoice->id }}" class="rounded border-zinc-300 bg-white text-zinc-900 focus:ring-zinc-900 dark:border-zinc-700 dark:bg-zinc-800 dark:text-zinc-100 dark:focus:ring-zinc-600 {{ $isSelected ? 'ring-1 ring-zinc-900/20 dark:ring-zinc-100/20' : '' }}" />
                                </td>
                                @if($visibleColumns['invoice_number'])
