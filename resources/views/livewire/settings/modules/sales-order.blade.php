    ...
    <div class="space-y-8">
        ...
        <section>
            ...
            <div class="-mx-4 mb-6 border-y border-zinc-200 bg-zinc-100 px-4 py-2.5 sm:-mx-6 sm:px-6 lg:-mx-8 lg:px-8 dark:border-zinc-800 dark:bg-zinc-800/50">
                <h2 class="text-sm font-semibold text-zinc-900 dark:text-zinc-100">Quotation</h2>
            </div>
        ...
        <section>
            {{-- Section Header (Odoo-style) --}}
            <div class="-mx-4 mb-6 border-y border-zinc-200 bg-zinc-100 px-4 py-2.5 sm:-mx-6 sm:px-6 lg:-mx-8 lg:px-8 dark:border-zinc-800 dark:bg-zinc-800/50">
                <h2 class="text-sm font-semibold text-zinc-900 dark:text-zinc-100">Pricing</h2>
            </div>
