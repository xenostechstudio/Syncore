        ...
        <div class="flex w-full items-center justify-between gap-4">
            <div class="flex items-center gap-3">
                <button
                    type="button"
                    x-data="{ saving: false }"
                    x-on:click="saving = true; Livewire.dispatch('saveRoleForm')"
                    x-on:role-form-save-complete.window="saving = false"
            ...
            @if($roleId)
                <button
                    ...
                    x-on:click="if (confirm('Delete this role? This action cannot be undone.')) { deleting = true; Livewire.dispatch('deleteRoleForm') }"
                    x-on:role-form-delete-complete.window="deleting = false"
                ...
                >
                    <svg x-show="deleting" class="size-4 animate-spin" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
                        <circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"></circle>
                        <path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path>
                    </svg>
                    <flux:icon x-show="!deleting" name="trash" class="size-4" />
