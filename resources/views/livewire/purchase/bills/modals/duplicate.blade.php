...
>
    <div class="mb-4 flex items-center gap-3">
        <div class="flex h-10 w-10 items-center justify-center rounded-full bg-zinc-100 dark:bg-zinc-800">
            <flux:icon name="document-duplicate" class="size-5 text-zinc-600 dark:text-zinc-400" />
        </div>
        <div>
            <h3 class="text-lg font-semibold text-zinc-900 dark:text-zinc-100">Duplicate Vendor Bill</h3>
            <p class="text-sm text-zinc-500 dark:text-zinc-400">A new draft bill will be created from this one.</p>
        </div>
    </div>
    ...
    <div class="flex justify-end gap-3">
        ...
        >
            ...
            <span wire:loading.remove wire:target="duplicate">Duplicate Bill</span>
