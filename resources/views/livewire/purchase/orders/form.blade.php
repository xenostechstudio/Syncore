<div x-data="{ activeTab: 'products', showSendMessage: false, showLogNote: false, showScheduleActivity: false, showCancelModal: false }">
    <x-slot:header>
        <div class="flex items-center justify-between gap-4">
            ...
            <div class="flex items-center gap-3">
                <a href="{{ route('purchase.orders.index') }}" wire:navigate class="flex items-center justify-center rounded-md p-1 text-zinc-400 transition-colors hover:bg-zinc-100 hover:text-zinc-600 dark:hover:bg-zinc-800 dark:hover:text-zinc-300">
                ...
                <div class="flex flex-col">
                    ...
                    {{-- PO number + gear dropdown inline --}}
                                    ...
                                    @forelse($lines as $index => $line)
                                        ...
                                        >
                                            ...
                                            <td class="pl-2 pr-2 py-2 text-right">
                                                @if(count($lines) > 1 && $status !== 'done' && $status !== 'cancelled')
                                                    <button 
                                                        type="button"
                        ...
                        @else
                            ...
                            <div class="flex items-start gap-3">
                                ...
                                <div class="flex-1 min-w-0">
                                    ...
                                    <p class="text-sm text-zinc-600 dark:text-zinc-400">Purchase order created</p>
                                </div>
                            </div>
                        @endif
                    </div>
    ...
    <x-ui.confirm-modal show="showCancelModal">
        ...
        <x-slot:description>
            This action will cancel the purchase order and cannot be undone. Are you sure you want to proceed?
        </x-slot:description>
