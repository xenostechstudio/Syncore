            ...
            <div class="lg:col-span-3">
                        ...
                        <div class="flex gap-3">
                            ...
                            <div class="min-w-0 flex-1">
                                <div class="flex items-center gap-2">
                                    ...
                                    <span class="text-xs text-zinc-400 dark:text-zinc-500">{{ optional($warehouse->created_at)->format('H:i') ?? now()->format('H:i') }}</span>
                                </div>
                ...
                @else
                    ...
                    <div class="py-8 text-center">
                        ...
                        <p class="text-xs text-zinc-400 dark:text-zinc-500">Activity will appear here once the warehouse is saved</p>
                    </div>
                @endif
            </div>
        </div>
