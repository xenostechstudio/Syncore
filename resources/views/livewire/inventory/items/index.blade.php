<div>
    <x-ui.flash />    <x-ui.index-header
        title="Items"
        :createRoute="route('inventory.products.create')"
        :paginator="$items"
        :view="$view"
        :views="['list', 'kanban']"
    >
                                        ...
                                        <div class="flex-1 md:pl-3">
                                            ...
                                            <div class="space-y-1">
                                                @foreach([
                                                    ...
                                                    'name' => __('common.name'),
                                                    'price_high' => __('common.price_high_to_low'),
                                                    'price_low' => __('common.price_low_to_high'),
                                                    'stock_high' => __('common.stock_high_to_low'),
                                                    'stock_low' => __('common.stock_low_to_high'),
                                                ] as $value => $label)
