        ...
        <div class="lg:col-span-3">
                ...
                <div class="flex gap-3">
                    ...
                    <div class="flex-1">
                        ...
                        <div class="mt-2 flex items-center justify-between">
                            ...
                            <button type="button" class="rounded-lg bg-blue-600 px-3 py-1.5 text-xs font-medium text-white transition-colors hover:bg-blue-700">Send</button>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="flex gap-3">
                    ...
                    <div class="flex-1">
                        ...
                        <div class="mt-2 flex items-center justify-between">
                            ...
                            <button type="button" class="rounded-lg bg-amber-600 px-3 py-1.5 text-xs font-medium text-white transition-colors hover:bg-amber-700">Log Note</button>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="flex gap-3">
                    ...
                    <div class="flex-1 space-y-3">
                        ...
                        <div class="flex justify-end">
                            <button type="button" class="rounded-lg bg-violet-600 px-3 py-1.5 text-xs font-medium text-white transition-colors hover:bg-violet-700">Schedule</button>
                        </div>
                    </div>
                </div>
            </div>
            ...
            @else
                ...
                <div class="py-8 text-center">
                    ...
                    <p class="text-xs text-zinc-400 dark:text-zinc-500">Activity will appear here once the transfer is saved</p>
                </div>
            @endif
        </div>
        </div>
