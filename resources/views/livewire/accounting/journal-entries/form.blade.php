                ...
                @if($entryId)
                    ...
                    <div class="space-y-4">
                        @forelse($activities as $item)
                            ...
                            @else
                                {{-- Activity Log Item --}}
                                <x-ui.activity-item :activity="$item['data']" emptyMessage="Journal entry created" />
                            @endif
                        @empty
                            {{-- Entry Created (fallback when no activities yet) --}}
                            <div class="flex items-start gap-3">
                                <div class="flex-shrink-0">
                                ...
                                <div class="flex-1 min-w-0">
                                    ...
                                    <p class="text-sm text-zinc-600 dark:text-zinc-400">Journal entry created</p>
                                </div>
                            </div>
                        @endforelse
                    </div>
