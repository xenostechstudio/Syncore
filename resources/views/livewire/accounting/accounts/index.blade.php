<div>
    <x-ui.flash />    <x-ui.index-header
        title="Accounts"
        :createRoute="route('accounting.accounts.create')"
        :paginator="$accounts"
        :view="$view"
        :views="['list']"
    >
        ...
        <x-slot:search>
                ...
                {{-- Export --}}
                            ...
                            @else
                                {{-- Search & Filter --}}
                                <x-ui.searchbox-dropdown placeholder="Search accounts..." widthClass="w-[420px]" width="420px" :activeFilterCount="$this->getActiveFilterCount()" clearAction="clearFilters">
    ...
    <div>
        @if($accounts->isEmpty())
            ...
            <x-ui.empty-state
                ...
                :actionUrl="route('accounting.accounts.create')"
            ...
            <div class="-mx-4 -mt-6 -mb-6 overflow-x-auto bg-white sm:-mx-6 lg:-mx-8 dark:bg-zinc-900">
                <table class="min-w-full divide-y divide-zinc-200 dark:divide-zinc-800">
                    ...
                    <tbody class="divide-y divide-zinc-200 dark:divide-zinc-800">
                        @foreach($accounts as $account)
                            @php $isSelected = in_array($account->id, $selected); @endphp
                            <tr 
