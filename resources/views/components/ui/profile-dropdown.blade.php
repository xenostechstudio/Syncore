            ...
            @if($isOutOfOffice)
                <div class="mt-3 rounded-lg bg-amber-50 p-2.5 dark:bg-amber-900/20">
                    <div class="flex items-center gap-2">
                        ...
                        <span class="text-xs font-medium text-amber-700 dark:text-amber-300">{{ __('common.out_of_office') }}</span>
                    </div>
        ...
        <div class="px-4 py-3" x-data>
            <div class="flex items-center justify-between">
                <div class="flex items-center gap-2">
                    ...
                    <span class="text-sm text-zinc-600 dark:text-zinc-400">{{ __('settings.locale') }}</span>
                </div>
                <div class="flex items-center gap-1 rounded-lg border border-zinc-200 bg-zinc-50 p-1 dark:border-zinc-700 dark:bg-zinc-800">
                    <form method="POST" action="{{ route('locale.switch') }}" data-turbo="false">
                        @csrf
